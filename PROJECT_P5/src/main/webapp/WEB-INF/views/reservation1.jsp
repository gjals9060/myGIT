...
<body>
	...
	<div id="mapWrapper" style="float: right; width: 545px; height: 545px; position:fixed; top: 50px; right:0; z-index: 3; border: 2px solid;">
			<!--     	
    ...
    <div id="button1" class='toggleBG' style="float: right; position:fixed; top: 60px; right:450px; z-index: 5;">
   		<button class='toggleFG'></button>
	</div>
	
	<button id="button1" class="buttonMap" style="vertical-align:middle; text-align: right; float: right; position:fixed; top: 56px; right:300px; z-index: 4;">    
   		<strong><font size="2"> 지도를 움직이며 검색 &nbsp; </font></strong>
	</button>
	
	<button id="button2" class="buttonMap" style="vertical-align:middle; text-align: center; float: right; position:fixed; top: 56px; right:300px; z-index: 4;">    
   		<strong><font size="2"> 이 지역 검색 &nbsp; </font></strong>
	</button>
	
	<div id="loading" class="buttonMap" style="vertical-align:middle; text-align: center; float: right; position:fixed; top: 56px; right:300px; z-index: 6;">    
