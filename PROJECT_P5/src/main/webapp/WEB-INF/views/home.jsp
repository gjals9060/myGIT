...
<body>
	...
	<form action="" name="useraddTest">
		<div id="modalUseradd" class="modal">
			...
			<div class="modal-popup">
				...
				<div class="formInput">
					<input type="text" class="input-value" id="inputFristName"
						name="userFristName" />
				</div>
				<div class="formCheck"></div>
				<br>
	...
	<div id="modal-email-check" class="modal">
		...
		<div class="modal-popup">
			...
			<br />
			<!-- 이메일 인증 input -->
			<input type="text" name="emailCheck" /> <input type="button"
				name="emailCheckBtn" value="인증" /> <input type="button" value="재요청" />
			<input type="hidden" /> <br /> <br /> <input type="button"
	...
	<div id="modalEmailCheck" class="modal">
		...
		<div class="modal-popup">
			...
			<!-- 이메일 인증 input -->
			<input type="text" name="emailCheck" /> <input type="button"
				name="emailCheckBtn" value="재요청" id="emailCheckBtn" />
			<!-- 이메일 인증번호 input -->
			<input type="hidden" id="emailAuthenticationId" /> <br /> <br /> <input
				type="button" value="완료" onclick="useraddTest.submit()" />
		</div>
	...
	<form action="reservation1">
		...
		<div class="wrap" id="idWrap">
			...
			<div class="reservation">
				...
				<span class="input-text">인원</span> <input type='text'
					name='personnel' class="personnel_input" value="0">
				...
				<i class="fa fa-search" aria-hidden="true"></i><input type="submit"
					value="검색" />
