...
<div id="minimum">
	<input type="number" name="minimumStay" class="minimum-date"  value="1"   /><span class="text-info">박(최소)</span>
	...
	<div id="maximum">
	<input type="number" name="maximumStay" class="maximum-date"  value="1"  /><span class="text-info">박(최대)</span>
